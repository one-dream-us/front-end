...
import ibelong2You from '@/assets/mp3/G-DRAGON - IBELONGIIU.mp3';
import blueSong from '@/assets/mp3/BIGBANG - BLUE.mp3';
import fanbe from '@/assets/mp3/BIGBANG - FANTASTIC BABY.mp3';
import stillLife from '@/assets/mp3/BIGBANG - 봄여름가을겨울 (Still Life).mp3';

const Player = () => {
  const songs = [
    { title: '봄여가겨', file: stillLife },
    ...
    { title: 'IBELONGIIU', file: ibelong2You },
    { title: 'FANTASTIC BABY', file: fanbe },
  ];
