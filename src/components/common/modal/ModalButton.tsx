export default function ModalButton({
  ...
  return (
    <div className='flex h-[44px] w-full gap-x-2 self-center transition'>
      <button
        onClick={onClose}
        className='h-[44px] w-1/2 cursor-pointer whitespace-nowrap rounded bg-custom-gray-300 px-[59px] py-3 text-xs font-medium text-custom-gray-dark transition-all duration-200 hover:bg-hover-30'
      >
        {buttonText.close}
      </button>
