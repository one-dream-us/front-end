        ...
        {tags.map((tag, index) => (
          ...
          >
            ...
            {withTooltip && showTooltip && index === 0 && (
              <div className="absolute -left-7 -top-2.5 z-[999] w-[266px] -translate-y-full rounded bg-custom-gray-dark px-2.5 py-2 text-xs text-custom-cream-light drop-shadow-xl after:absolute after:left-8 after:top-full after:border-x-[6px] after:border-t-[8px] after:border-transparent after:border-t-custom-gray-dark after:content-['']">
