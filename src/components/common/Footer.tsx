...
export default function Footer() {
  return (
    <footer className='flex h-[140px] w-full items-center justify-center bg-custom-gray-lighter px-4 text-custom-gray-dark md:px-6 desktop:h-[120px] desktop:px-0'>
      <div className='flex h-[79px] w-full items-center justify-between text-[10px] md:h-[85px] md:items-end md:text-xs desktop:w-[1440px] desktop:px-[129px]'>
        ...
        <nav>
          <ul className='gap-y-2 underline md:flex md:gap-x-10 md:gap-y-0'>
