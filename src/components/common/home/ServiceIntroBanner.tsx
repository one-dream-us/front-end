  ...
  return (
    <section className='mt-[60px] flex h-[190px] w-full flex-col items-center justify-center bg-custom-gray-dark text-center md:h-[223px] desktop:mt-20'>
      ...
      <Link
        ...
        target='_blank'
      >
        <button className='flex h-[40px] w-[155px] items-center justify-center gap-x-1 rounded-3xl bg-white text-sm font-bold transition-all duration-200 hover:opacity-65'>
