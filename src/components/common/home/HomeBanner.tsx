...
export default function HomeBanner() {
  return (
    <section className='md: mb-[40px] h-[321px] w-full bg-custom-cream-light md:mb-[60px] md:flex md:h-[268px] md:flex-row-reverse md:items-center md:justify-end desktop:mb-[80px] desktop:h-[376px] desktop:justify-end'>
