...
export default function ProfileSection({
  ...
  const { text, progressBarWidth } = useProfileSectionLogic(totalKeyNote);
  ...
  return (
    <div className='h-[126px] w-full'>
      ...
      {totalKeyNote < 3 ? (
        <div className='mt-1 h-8 place-self-end rounded-full border border-custom-gray-200 px-2.5 py-1 text-sm font-medium leading-170 text-gray-070'>
