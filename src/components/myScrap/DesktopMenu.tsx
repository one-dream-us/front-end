...
export default function DesktopMenu({
  ...
  return (
    <ul className='relative hidden h-[58px] w-[71px] flex-col gap-y-[17px] self-start text-sm before:absolute before:left-0 before:top-[3px] before:h-[54px] before:w-[1px] before:bg-custom-gray-500 desktop:flex'>
      {MenuItems.map((item) => (
        <li
          key={item}
          onClick={() => {
