  ...
  return (
    <div className='absolute left-0 top-0 flex h-screen w-full'>
      <div className='flex w-full flex-1 items-center justify-center bg-white'>
        <div className='desktop:w-[488px] m-auto w-[343px] px-4 md:w-[368px]'>
          <div className='desktop:mb-56 desktop:h-[72px] m-auto mb-44 flex h-14 w-full items-center justify-center text-4xl font-extrabold md:mb-60'>
